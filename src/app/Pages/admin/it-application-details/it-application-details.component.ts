...
@Component({
  selector: 'app-it-application-details',
  standalone: true,
  ...
  templateUrl: './it-application-details.component.html',
  styleUrl: './it-application-details.component.css'
})
export class ItApplicationDetailsComponent {
